...
paths.angularScripts = [
  ...
  paths.node + '/angular-messages/angular-messages.js',
  paths.node + '/angular-resource/angular-resource.min.js',
  paths.node + '/angular-translate/dist/angular-translate.js',
  paths.node + '/angular-i18n/angular-locale_pt-br.js',
  paths.node + '/angular-i18n/angular-locale_de.js',
  paths.node + '/angular-i18n/angular-locale_en-gb.js',
  ...
  paths.node + '/ng-c2/dist/ng-c2.js',
  paths.node + '/lf-ng-md-file-input/dist/lf-ng-md-file-input.js',
  paths.node + '/angular-simple-logger/dist/angular-simple-logger.min.js',
  paths.node + '/ui-leaflet/dist/ui-leaflet.js',   
  paths.node + '/leaflet-plugins/layer/tile/Bing.js',
  paths.node + '/ui-leaflet-layers/dist/ui-leaflet-layers.min.js',  
  paths.node + '/sortablejs/Sortable.js',
  paths.node + '/angular-legacy-sortablejs-maintained/angular-legacy-sortable.js',
  paths.node + '/@iamadamjowett/angular-click-outside/clickoutside.directive.js'
];
//Add minifieds files.
paths.vendorsScripts = [
  ...
  paths.node + '/leaflet-draw/dist/leaflet.draw.js',
  paths.node + '/leaflet-wfst/dist/leaflet-wfst.min.js'
];
paths.scripts = [
  paths.app + '/app.js',
  paths.app + '/app.*.js',
...
paths.styles = [
  paths.node   + '/ng-c2/dist/ng-c2.css',
  paths.node   + '/leaflet/dist/leaflet.css',
  paths.node   + '/leaflet-draw/dist/leaflet.draw.css',
...
function images(){  
  gulp.src('./node_modules/**/dist/**/*.{png,gif,jpg,svg}')
  .pipe(flatten())
...
gulp.task('build', function() {
  runSequence(['styles', 'scriptsVendors', 'scriptsAngular', 'scriptsApplication', 'images'], 'injectFiles');
});
...
gulp.task('check', function() {
  gutil.log(gutil.colors.blue('Executing the eslint analysis'));
